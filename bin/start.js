...
exports.run = function(params) {
  ...
  (() => {
    new Promise((resolve, reject) => {
      ...
      console.log(`Ahoy => deploy proccess complete. Make sure you have GitHub Pages enabled in this project settings ok?`)
    }).catch((err) => {
      console.log(`Oh noes => Something went wrong during the building proccess. Here's the output: ${err}`)
    })
  })()
};
